    ...
    <b-row>
        <b-col cols="12">
            ...
            <div class="chat-box" v-chat-scroll>
                <b-list-group>
                    <b-list-group-item class="chat-time" v-for="chat in chats" :key="chat.key">
                        ...
                        <div v-else>
                            ...
                            <div class="chat-message text-left" text-left v-if="chat.user !== nickname">
                                <div class="left-bubble">
                                    ...
                                    <span class="msg-date">{{chat.senDate}}</span>
                                    <p text-wrap>{{chat.message}}</p>
                                </div>
                            </div>
                        </div>
            ...
            <footer class="sticky-footer">
                <b-form @submit="onSubmit">
                    <b-input-group>
                        <b-form-input id="message" v-model.trim="data.message" placeholder="Enter Your Messsage"></b-form-input>
...
<style>
    ...
    .chat-mesage .right-bubble span.msg-date{
        font-size: 10px;
        display: block;
    }
